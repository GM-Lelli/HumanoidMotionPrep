...
namespace emilianavt.BVHParserLib
{
    public class BVHAnimationLoader : MonoBehaviour
    {
        ...
        [Tooltip("Directory where the AnimationClip will be saved")]
        public string saveDirectory = "Assets/Animations/";
        ...
        public void loadAnimation()
        {
            ...
            // Salva l'AnimationClip in una cartella specifica
#if UNITY_EDITOR
            if (!Directory.Exists(saveDirectory))
            {
                Directory.CreateDirectory(saveDirectory);
            }
            AssetDatabase.CreateAsset(clip, Path.Combine(saveDirectory, clip.name + ".anim"));
